  ...
  .hidden-phone
    ...
    .container.pt
      .padded-container.flex.flex-column
        h3 {{ title2 }}
        p {{ text2 }}
        img(src='/static/cases/DBI/DBIBigScreen@2x.png', width='100%')
    ...
    .gray.container.pt
      ...
      .with-image.flex.pt.flex-align-center
        .flex.flex-column
          ...
          p DBI zocht een partij die hun ondergrondse en bovengrondse afvalcontainers beheersbaar kon maken in één systeem. Via een gezamenlijke partner kwamen ze bij ons terecht.
