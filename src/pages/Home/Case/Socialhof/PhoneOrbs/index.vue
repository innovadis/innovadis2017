...
.phone-container(v-inview:once.enter='animateOrbs')
  .phone
  orb.orb(ref='orb0', icon='birthday-cake', :fadeIn='false')
  orb.orb(ref='orb1', icon='birthday-cake', :fadeIn='false')
  orb.orb(ref='orb2', icon='birthday-cake', :fadeIn='false')
  orb.orb(ref='orb3', icon='birthday-cake', :fadeIn='false')
  orb.orb(ref='orb4', icon='birthday-cake', :fadeIn='false')
